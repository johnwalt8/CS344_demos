...
function generate(){
    # NAME
    #   generate - generate a matrix of a specified value
    # SYNOPSIS
    ...
    #   with 'D' or 'd', the matirx will be populated with ones along the diagonal entries.
    # AUTHOR
    #   Written by Ryan Gambord (gambord@oregonstate.edu)

    [ $# -ne 3 ] && echo "invalid number of arguments" >&2  # This is equivalent to using an if
